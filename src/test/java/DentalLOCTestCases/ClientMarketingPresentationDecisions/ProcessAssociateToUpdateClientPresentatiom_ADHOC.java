...
public class ProcessAssociateToUpdateClientPresentatiom_ADHOC extends TestBase {
	    ...
	    click("TaskHyperLink");
		 ...
		 for(int i=1; i<=30;i++) {
			 ...
			 System.out.println("I value :" +i); 
				...
				String ActualTaskValue = "ADHOC TASK";
				...
				if (INP.equalsIgnoreCase(COM) && ActualTaskValue.equalsIgnoreCase(TaskxpathValue)) {
					...
					System.out.println("ADHOC TASK");
					Thread.sleep(30000);
					scrollToBotton();
					Thread.sleep(2000);
					click("AddAttachment");
					Thread.sleep(2000);
					//Not Working attachment
