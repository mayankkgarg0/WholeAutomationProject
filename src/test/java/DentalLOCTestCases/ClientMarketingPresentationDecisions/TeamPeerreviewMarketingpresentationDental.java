...
public class TeamPeerreviewMarketingpresentationDental extends TestBase {
	    ...
	    click("TaskHyperLink");
		 ...
		 for(int i=1; i<=30;i++) {
			 ...
			 System.out.println("I value :" +i); 
				...
				String ActualTaskValue = "Team Peer review Marketing presentation - Dental";
				...
				if (INP.equalsIgnoreCase(COM) && ActualTaskValue.equalsIgnoreCase(TaskxpathValue)) {
					...
					System.out.println("Sixth Task of Marketing Meeting Followups Dental");
					Thread.sleep(30000);
					scrollToBotton();
					Thread.sleep(2000);
					click("ApproveButton");
