...
public class CreatevendormarketingnotificationsclientsdecisionsDental extends TestBase {
	    ...
	    click("TaskHyperLink");
		 ...
		 for(int i=1; i<=30;i++) {
			...
			// javascript executor for scroll down
				...
				String ActualTaskValue = "Create vendor marketing notifications of clients decisions for each LOC - Dental";
				if (INP.equalsIgnoreCase(COM) && ActualTaskValue.equalsIgnoreCase(TaskxpathValue)) {
					...
					System.out.println("Tenth Task of Marketing Meeting Followups Dental");
					Thread.sleep(30000);
					scrollToTOPOfPage();
					Thread.sleep(2000);
					click("CreateEmail");
					Thread.sleep(2000);
					select("AddVendorEmail", AddVendorEmailValue );
					Thread.sleep(2000);
					type("Task10EmailTemplate", TaskDescription);
					Thread.sleep(2000);
					click("SubmitButton");
					Thread.sleep(4000);
					click("complete");
